...
.then(() => {
    ...
    }) //the mongodb database is now connected but our application has not started listening using the database this app.listen() will make sure our application is listening to the database
    app.on("error", (error) => {
